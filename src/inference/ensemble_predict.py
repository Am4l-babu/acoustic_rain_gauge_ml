...
(CNN 0.277, XGBoost-optimized 0.226 -- see docs/reports/dl_ablation_full_report.json
and docs/reports/model_evaluation_report_optimized.json). They see different
...
This script:
  ...
  5. Also retrains the XGBoost classifier (SHAP-selected is_rainy features)
     ...
     meta-learner (src/training/ensemble_stack.py), since it's a differently-shaped
...
Run:
    python src/inference/ensemble_predict.py --master-store-dir F:\\master_feature_store \\

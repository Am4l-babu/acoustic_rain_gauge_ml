...
# Auto-detected: this file lives at src/dl/dl_dataset.py, so three levels up
# is the repo root, and one more above that is the HDD root, whether that's
# a Windows drive letter or a Linux mount point -- same convention as

...
Usage:
    python src/features/feature_selection.py                  # top 30 (default)
    python src/features/feature_selection.py --top-n 20
"""
import argparse
...
# OS/mount agnostic: this file lives at src/features/feature_selection.py, so
# three levels up is the HDD's root, whether that's a Windows drive letter or
# a Linux mount point, rather than a hardcoded drive -- matches
# master_feature_extraction.py.

...
cosine LR decay (see docs/reports/dl_ablation_full_report.json). The natural next
...
Run:
    python src/evaluation/diagnose_dl_stability.py --dl-models-dir F:\\acoustic_rain_gauge_ml\\models
"""
import argparse
import json
import sys
...
from training.train_dl_model import evaluate
